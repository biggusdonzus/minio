...
import (
	...
	"github.com/biggusdonzus/minio/internal/config/browser"

	"github.com/minio/madmin-go/v3"
	"github.com/biggusdonzus/minio/internal/config"
	"github.com/biggusdonzus/minio/internal/config/api"
	"github.com/biggusdonzus/minio/internal/config/batch"
	"github.com/biggusdonzus/minio/internal/config/callhome"
	"github.com/biggusdonzus/minio/internal/config/compress"
	"github.com/biggusdonzus/minio/internal/config/dns"
	"github.com/biggusdonzus/minio/internal/config/drive"
	"github.com/biggusdonzus/minio/internal/config/etcd"
	"github.com/biggusdonzus/minio/internal/config/heal"
	xldap "github.com/biggusdonzus/minio/internal/config/identity/ldap"
	"github.com/biggusdonzus/minio/internal/config/identity/openid"
	idplugin "github.com/biggusdonzus/minio/internal/config/identity/plugin"
	xtls "github.com/biggusdonzus/minio/internal/config/identity/tls"
	"github.com/biggusdonzus/minio/internal/config/ilm"
	"github.com/biggusdonzus/minio/internal/config/lambda"
	"github.com/biggusdonzus/minio/internal/config/notify"
	"github.com/biggusdonzus/minio/internal/config/policy/opa"
	polplugin "github.com/biggusdonzus/minio/internal/config/policy/plugin"
	"github.com/biggusdonzus/minio/internal/config/scanner"
	"github.com/biggusdonzus/minio/internal/config/storageclass"
	"github.com/biggusdonzus/minio/internal/config/subnet"
	"github.com/biggusdonzus/minio/internal/crypto"
